...
class TestCasesReview(unittest.TestCase):
    ...
    def test_attr_test(self):
        ...
        self.r1.name = "Cool"
        self.r2.name = "Not Cool"
        self.assertEqual(self.r1.name, "Cool")
        self.assertEqual(self.r2.name, "Not Cool")

    def test_update_name(self):
        """Check for update user name attributes"""

        self.r1.name = "Computer"
        self.r2.name = "Computer or Laptop"
        self.r1.name = "Computer"
        self.assertEqual(self.r1.name, "Computer")
        self.assertEqual(self.r2.name, "Computer or Laptop")
